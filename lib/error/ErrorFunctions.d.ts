...
export declare const redirectURL = "/signin";
...
export declare const GeneralSessonError: GeneralErrorHandlerFactory;
export declare const RedirectHandler: (logger: Logger) => (errorEnum: ErrorEnum) => ResponseHandler;
