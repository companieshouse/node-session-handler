...
function sessionRequestHandler(config, sessionStore) {
    return (request, response, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        ErrorFunctions_1.appLogger().debug(`Sesssion Cookie: ${sessionCookie}`);
        if (sessionCookie) {
            ...
            yield loadSession.either((failure) => __awaiter(this, void 0, void 0, function* () {
                ErrorFunctions_1.appLogger().info(`Error occurred in session load sequence. Handling failure...`);
                ...
                ErrorFunctions_1.appLogger().info(`Session loaded successfully!`);
