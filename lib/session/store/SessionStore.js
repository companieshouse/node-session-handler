...
class SessionStore {
    constructor(redis) {
        ...
        this.load = (cookie) => __awaiter(this, void 0, void 0, function* () {
            Logger_1.loggerInstance().debug(`Loading from session store - COOKIE ID: ${cookie.sessionId}`);
        ...
        this.store = (cookie, value, timeToLiveInSeconds = 3600) => __awaiter(this, void 0, void 0, function* () {
            Logger_1.loggerInstance().debug(`Storing in session store - COOKIE ID: ${cookie.sessionId}`);
        ...
        this.delete = (cookie) => __awaiter(this, void 0, void 0, function* () {
            Logger_1.loggerInstance().debug(`Deleting from session store - COOKIE ID: ${cookie.sessionId}`);
