...
function calculateSecondsSinceEpoch() {
...
class SessionStore {
    constructor(redis) {
        ...
        this.store = (cookie, value, timeToLiveInSeconds = 3600) => {
            value[SessionKey_1.SessionKey.Expires] = calculateSecondsSinceEpoch() + timeToLiveInSeconds;
...
class RedisWrapper {
    constructor(client) {
        this.client = client;
        this.set = (key, value, timeToLiveInSeconds) => {
