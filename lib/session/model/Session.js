...
class VerifiedSession extends Session {
    ...
    static createNewVerifiedSession(config, extraData) {
        ...
        const accessToken = AccessToken_1.AccessToken.createDefaultAccessToken(config.defaultSessionExpiration);
        const signInInfo = {
            [SessionKeys_1.SessionKeys.AccessToken]: accessToken,
        ...
        sessionData[SessionKeys_1.SessionKeys.Expires] = Date.now() + accessToken.expires_in * 1000;
