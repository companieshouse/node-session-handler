...
const validateCookieSignature = (sessionSecret: string) => (cookieString: string): Either<Failure, Tuple<string, string>> => {
    if (!sessionSecret) {
...
export class Cookie {
    ...
    public static create(sessionSecret: string): Cookie {
